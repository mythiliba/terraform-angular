...
resource "aws_ecs_task_definition" "my_task_definition" {
  ...
  cpu = "256"   # Set the CPU units required by your Angular application
  memory = "512"  # Set the memory required by your Angular application

  container_definitions = <<EOF
  [
    {
      "name": "angular-container",
      "image": "iamguri/angular-helloworld",  
      "portMappings": [
        {
          "containerPort": 80,
          "hostPort": 80,
